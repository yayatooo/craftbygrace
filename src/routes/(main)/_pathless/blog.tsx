	...
	return (
		<main>
			...
			<p className="text-muted-foreground py-2">
				Writing may not be my strongest suit, but sharing is something I love to
				do. Here, you will find a collection of thoughts, lessons, and small
				discoveries from my mind—shared in the hope that someone out there finds
				them useful.
			</p>
